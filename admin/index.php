    ...
    <?php switch($_REQUEST['action']):
        ...
        case "test": ?>
            <div class="ui-grid-a">
                ...
                <div class="ui-block-b" style="max-height:300px;"><?php if(isset($test['image'])): ?><img src="<?php echo $test['image'] ?>" /><?php endif; ?></div>
            </div>
    <?php case "view": ?>   
	<div data-role="content">  
    	...
    	<form method="post" action="?">
        	...
        	<div data-role="fieldcontain">
            	...
            	<input type="text" id="<?php echo $col ?>" name="<?php echo $col ?>" value="<?php echo isset($feed->$col) ? htmlentities($feed->$col) : '' ?>" />
        	</div>
        	<?php endforeach; ?>
